...
static TextDirection g_icu_text_direction = LEFT_TO_RIGHT;
static std::string g_configured_locale = "zh-CN";


// Convert the ICU default locale to a string.
std::string GetConfiguredLocale() { 
	return g_configured_locale;
}
...
void SetICUDefaultLocale(const std::string& locale_string) {
  g_configured_locale = locale_string; 
